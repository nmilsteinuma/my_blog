...
?equiv.clust
war_1000s.se_hamming<-equiv.clust(wars_1000s_for_equiv_clust, equiv.fun="sedist",cluster.method="complete", method="euclidean", mode="graph")

plot(war_1000s.se_hamming, labels=war_1000s.se_hamming$glabels,  cex=0.3, main="Cluster Dendrogram 1000s Hamming (Complete)")

rect.hclust(war_1000s.se_hamming$cluster,h=1)
