...
h4 <- hcl.colors(n, palette = "Dynamic")

network_atts_for_plot %>% mutate(century_for_graphing = as.character(century_for_graphing)) %>%
ggplot(aes(x=century_for_graphing, y=transitivity_over_time_global)) +
geom_bar(position = "dodge",
aes(fill = century_for_graphing), stat = "identity")+  
  scale_fill_manual(values=c(h4))+
  labs(title = "Global Transitivity by Century",
        x = "Century",
        y = "Global Transitvity")+
  guides(color=guide_legend(title="Century"))+
  theme_minimal()
...
network_atts_for_plot %>% mutate(century_for_graphing = as.character(century_for_graphing)) %>%
ggplot(aes(x=century_for_graphing, y=transitivity_over_time_average))+
geom_bar(position = "dodge", aes(fill = century_for_graphing), stat = "identity")+  
  scale_fill_manual(values=c(h4))+
  labs(title = "Average Transitivity by Century",
        x = "Century",
        y = "Average Transitvity")+
  guides(color=guide_legend(title="Century"))+
  theme_minimal()
...
network_atts_for_plot %>% mutate(century_for_graphing = as.character(century_for_graphing)) %>%
ggplot(aes(x=century_for_graphing, y=average_path_length_wars))+
geom_bar(position = "dodge", aes(fill = century_for_graphing),
             stat="identity")+  
  scale_fill_manual(values=c(h4))+
  labs(title = "Average Path Length by Century",
        x = "Century",
        y = "Average Path Length")+
  guides(fill=guide_legend(title="Century"))+
  theme_minimal()
...
network_atts_for_plot %>% mutate(century_for_graphing = as.character(century_for_graphing)) %>%
ggplot(aes(x=century_for_graphing, y=densities_over_time)) +
geom_bar(position="dodge", aes(fill = century_for_graphing),
         stat='identity')+  
  scale_fill_manual(values=c(h4))+
  labs(title = "Average Network Density by Century",
        x = "Century",
        y = "Average Network Density")+
  guides(fill=guide_legend(title="Century"))+
  theme_minimal()
...
network_atts_for_plot %>% mutate(century_for_graphing = as.character(century_for_graphing)) %>%
ggplot(aes(x=century_for_graphing, y=centralities_in_degree_over_time)) +
geom_bar(position="dodge", aes(fill = century_for_graphing),
         stat='identity')+  
  scale_fill_manual(values=c(h4))+
  labs(title = "Average Network Density by Century",
        x = "Century",
        y = "Average Network Centrality")+
  guides(fill=guide_legend(title="Century"))+
  theme_minimal()
...
nodes_1000s[-1] %>%
  ...
  ggplot(aes(value)) +
   ...
   labs(title = "1000s Node Attribute Distribtions")+
  theme_minimal()
...
nodes_1100s[-1] %>%
  ...
  ggplot(aes(value)) +
    geom_histogram() +
    facet_wrap(~key, scales = "free")+  
   labs(title = "1100s Node Attribute Distribtions")+
  theme_minimal()
...
nodes_1200s[-1] %>% 
  ...
  ggplot(aes(value)) +
    geom_histogram() +
    facet_wrap(~key, scales = "free")+  
   labs(title = "1200s Node Attribute Distribtions")+
  theme_minimal()
...
nodes_1300s[-1] %>%
  ...
  ggplot(aes(value)) +
    geom_histogram() +
    facet_wrap(~key, scales = "free")+  
   labs(title = "1300s Node Attribute Distribtions")+
  theme_minimal()

```

##### Histogram 1400s Nodes Distribution
...
nodes_1400s[-1] %>%
  ...
  ggplot(aes(value)) +
    geom_histogram() +
    facet_wrap(~key, scales = "free")+  
   labs(title = "1400s Node Attribute Distribtions")+
  theme_minimal()
...
nodes_1500s[-1] %>%
  ...
  ggplot(aes(value)) +
    geom_histogram() +
    facet_wrap(~key, scales = "free")+  
   labs(title = "1500s Node Attribute Distribtions")+
  theme_minimal()
...
nodes_1600s[-1] %>%
  ...
  ggplot(aes(value)) +
    geom_histogram() +
    facet_wrap(~key, scales = "free")+  
   labs(title = "1600s Node Attribute Distribtions")+
  theme_minimal()
...
nodes_1700s[-1] %>%
  ...
  ggplot(aes(value)) +
    geom_histogram() +
    facet_wrap(~key, scales = "free")+  
   labs(title = "1700s Node Attribute Distribtions")+
  theme_minimal()
...
nodes_1400s[-1] %>% 
  ...
  ggplot(aes(value)) +
    geom_histogram() +
    facet_wrap(~key, scales = "free")+  
   labs(title = "1800s Node Attribute Distribtions")+
  theme_minimal()
...
##### Nodes Betweeness Centralization 
...
#### Structural Equivalence 1000s Sedist 
...
#### Structural Equivalence 1000s Average
...
triad_census_1000s <- sna::triad.census(wars_in_1000s_network)
triad_census_1100s <- sna::triad.census(wars_in_1100s_network)
triad_census_1200s <- sna::triad.census(wars_in_1200s_network)
triad_census_1300s <- sna::triad.census(wars_in_1300s_network)
triad_census_1400s <- sna::triad.census(wars_in_1400s_network)
triad_census_1500s <- sna::triad.census(wars_in_1500s_network)
triad_census_1600s <- sna::triad.census(wars_in_1600s_network)
triad_census_1700s <- sna::triad.census(wars_in_1700s_network)
triad_census_1800s <- sna::triad.census(wars_in_1800s_network)


all_century_triads <- rbind(
as_tibble(sna::triad.census(wars_in_1000s_network)),
as_tibble(sna::triad.census(wars_in_1100s_network)),
as_tibble(sna::triad.census(wars_in_1200s_network)),
as_tibble(sna::triad.census(wars_in_1300s_network)),
as_tibble(sna::triad.census(wars_in_1400s_network)),
as_tibble(sna::triad.census(wars_in_1500s_network)),
as_tibble(sna::triad.census(wars_in_1600s_network)),
as_tibble(sna::triad.census(wars_in_1700s_network)),
as_tibble(sna::triad.census(wars_in_1800s_network)))

mdf <- all_century_triads/rowSums(all_century_triads)
mdf
```

Transitive  030T, 120D, 120U, 300

unique vector with all names of groups, code nodes not edges.


My dataset seems to have the problem of vacuous transitivity.
