...
ggbiplot(pr.out_2, labels =  total_1200s_for_PCA$name, labels.size  =1.5) + labs(title="Principal Components 1200s")+
  theme_minimal()
...
total_1100s_brokerag_reg_binom <- total_1100s_brokerag_reg %>% mutate(more_win_or_loss = case_when(
  win_rate < 0.5 ~ 0,
    win_rate >= 0.5 ~ 1))
...
ggbiplot(pr.out_2, labels =  total_1100s_for_PCA$name, labels.size  =1.5) + labs(title="Principal Components 1100s")+
  theme_minimal()
