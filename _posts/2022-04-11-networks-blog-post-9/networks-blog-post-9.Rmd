...
set.seed(777)
plot_1100s_network<-ggplot(wars_in_1000s_network, aes(x = x, y = y, xend = xend, yend = yend)) +
...
#pdf("ggplot_wars_network_1100.pdf") 
...
pdf("ggplot_wars_network_1200.pdf") 
...
```{r, echo=FALSE, warning=FALSE}
pdf("comm_clust_1000s.pdf") 

set.seed(123)

plot(comm.lab,wars_in_1000s.ig, vertex.size=0.5, edge.size=0.25, edge.arrow.size=.25,  vertex.label.dist=1.5,vertex.label.cex=0.25,asp = 0, main="Community Labels 1000s Conflicts")
...
plot(comm.lab,wars_in_1100s.ig, vertex.size=0.5, edge.size=0.25, edge.arrow.size=.25,  vertex.label.dist=1.5,vertex.label.cex=0.25,asp = 0)
...
total_1100s_for_PCA <- total_1100s_brokerag_reg_binom[,-c(16:23)]
...
total_1200s_brokerag_reg <- scale(total_1200s[,2:24])
...
plot(comm.lab,wars_in_1200s.ig, vertex.size=0.5, edge.size=0.25, edge.arrow.size=.25,  vertex.label.dist=1.5,vertex.label.cex=0.25,asp = 0)
...
pr.out_2 <- prcomp(total_1100s_for_PCA[-c(6,8)], scale = TRUE)
...
plot(as.phylo(hcd),type = "phylogram", use.edge.length = TRUE, tip.color = col_vector[clus4],edge.width = 0.5, label.offset = 0, cex = 0.2)
...
plot(as.phylo(hcd), type = "fan", tip.color = clus4,
