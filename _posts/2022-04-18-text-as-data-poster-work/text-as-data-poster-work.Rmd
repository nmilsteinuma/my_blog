...
#### N-Grams and the Removal of Common Terms
...
**Basis:** looking at the dimensions of the DTM we see it is 2711 x 40081
...
df_for_visualization_relevant <- as.data.frame(df_for_visualization[c(1 ,3, 4,10),])
...
df_for_visualization_relevant$frequency <- df_for_visualization_relevant$`df_for_visualization[c(1, 3, 4, 10), ]`
