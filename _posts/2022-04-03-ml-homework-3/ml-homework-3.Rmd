...
#squared_loadings %*% as.matrix(USArrests_scaled)

#sum(apply(as.matrix(USArrests2)^2, 2, sum))
...
hc.out <- hclust(dist(USArrests_scaled_2)) 
...
df_2_10<-as.data.frame(replicate(50,rnorm(n=20, mean=1)))

colnames(df_2_10)[1] <- "V1"

df_2_10_combined<-rbind(df_1_10, df_2_10)

df_3_10<-as.data.frame(replicate(50, rnorm(n=20, mean=0.5)))
